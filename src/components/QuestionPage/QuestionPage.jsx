...
const QuestionPage = () => {
  ...
  const fetchNextQuestion = async () => {
    try {
      ...
      const response = await axios.get('https://online-treasure-hunt-s53t.onrender.com/questions', { withCredentials: true });
  ...
  const handleAnswerSubmit = async () => {
    try {
      const response = await axios.post(
        `https://online-treasure-hunt-s53t.onrender.com/questions/${question.id}/answer`,
        { answer },
